...
namespace LoopLauncher.Services
{
    ...
    public class GameLauncher
    {
        ...
        private readonly string _launcherDir;  // Папка лаунчера: %AppData%\LoopLauncher
        ...
        public GameLauncher(ModpackService modpackService)
        {
            ...
            _launcherDir = Path.Combine(roaming, "LoopLauncher");
        ...
        private string GetUserDataPath()
        {
            ...
            if (!string.IsNullOrEmpty(SelectedModpackId))
            {
                ...
                var modpack = _modpackService.GetModpack(SelectedModpackId);
                
                if (modpack != null)
                {
                    return _modpackService.GetModpackUserDataPath(SelectedModpackId);
                }
